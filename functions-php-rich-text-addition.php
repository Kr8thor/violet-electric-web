...
// Register the rich text endpoint
...
// ============================================================================
// NETLIFY REBUILD HELPER FOR RICH TEXT
// ============================================================================
...
// Register the rich content display endpoint
add_action('rest_api_init', function() {
...
// ============================================================================
// ENHANCED SAVE HANDLER FOR RICH TEXT
// ============================================================================

// This updates the existing violetHandleSaveRequest JavaScript function
// Add this to the script section in violet_frontend_editor_page_fixed()
add_action('admin_footer', function() {
    ...
    ?>
    <script>
    // Override the save handler to support rich text
    window.violetEnhancedSaveRequest = function(data) {
    ...
    // Replace the existing handler if it exists
    if (typeof violetHandleSaveRequest === 'function') {
        violetHandleSaveRequest = violetEnhancedSaveRequest;
    }
    </script>
    <?php
});
...
// ============================================================================
// SUCCESS NOTICE FOR RICH TEXT
// ============================================================================

add_action('admin_notices', function() {
    if (current_user_can('manage_options') && isset($_GET['page']) && $_GET['page'] === 'violet-frontend-editor') {
        $rich_endpoint_exists = rest_url('violet/v1/content/rich');
        if ($rich_endpoint_exists) {
            echo '<div class="notice notice-success"><p><strong>✅ Rich Text Editor Support Active!</strong> Your editor now supports formatted text with bold, italic, colors, fonts, and more.</p></div>';
        }
    }
});

// End of rich text additions