        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in">
            <div className="relative">
              <img 
                ...
                src="/lovable-uploads/420a7493-73b2-4bfe-9a3a-9ad3693c0b9a.jpg" 
              />
          ...
          <div className="space-y-8 animate-fade-in">
            <div>
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-violet-600 to-blush-400 mb-6"></div>
            ...
            <Button variant="outline" className="border-blush-300 text-violet-700 hover:bg-blush-50 px-6 py-3 rounded-full transition-all duration-300">
