          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="text-gray-600 hover:text-violet-700 font-medium transition-colors duration-200 relative group"
              >
                {item.name}
          ...
          <div className="md:hidden py-4 border-t border-gray-100">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="block py-3 text-gray-600 hover:text-violet-700 font-medium transition-colors duration-200"
