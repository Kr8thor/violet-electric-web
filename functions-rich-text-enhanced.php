 ...
 */
function violet_get_rich_text_config() {
    return array(
        'quill' => array(
            'cdn_url' => 'https://cdn.quilljs.com/1.3.6/quill.min.js',
            'css_url' => 'https://cdn.quilljs.com/1.3.6/quill.snow.css',
            'theme' => 'snow',
            'modules' => array(
                'toolbar' => array(
        ...
        'lexical' => array(
            'theme' => array(
                ...
                'list' => array(
                    'ol' => 'violet-lexical-ol',
                    'ul' => 'violet-lexical-ul'
                )
            ),
            'nodes' => array(
                'HeadingNode',
        ...
        'common' => array(
            ...
            'placeholder_text' => 'Start typing your content...'
        )
    );
}
