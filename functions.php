...
function violet_frontend_editor_page_fixed() {
    ...
    (function() {
        ...
        function violetIsValidMessageOrigin(origin) {
            ...
            if (config.allowedMessageOrigins.length === 0 && origin === config.netlifyOrigin && config.netlifyOrigin !== '*') {
                return true;
            }
            ...
            violetLog('Blocked message from invalid origin', origin);
            return false;
        }
        ...
        function violetInitializeEditor() {
            try {
                ...
                if (iframe) {
                    // FIXED: Dynamically set iframe src with wp_origin parameter
        ...
        function violetHandleMessage(event) {
            try {
                ...
                violetLog('Received message from React page', event.data);
                    ...
                    if (xhr.readyState === 4) {
                        try {
                            ...
                            if (response.success) {
                                ...
                                violetShowNotification('✅ Changes saved successfully! React page updated.', 'success');
